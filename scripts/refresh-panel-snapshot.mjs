...
const sourceRulesMatchRelease = ruleBinding.every((item) => item.sourceMatchesRelease);
...
const generated = {
  ...
  authority: {
    ...
    releaseRecordSchema: releaseRecord.schema,
    releaseSourceWorktreeClean: releaseRecord.source_worktree_clean ?? null,
    releaseSourceInputsClean: releaseRecord.source_inputs_clean ?? null,
    releaseInputPaths: releaseRecord.input_paths ?? [],
    ...
    sourceMatchesRelease: sourceRulesMatchRelease,
