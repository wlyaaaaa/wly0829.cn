...
export const skills = [
  ...
  skill({
    slug: "chinese-asr",
    sourceBytes: 2616,
    sourceSha256: "0f8616b3dd52a201287c3efdf4d91d1a0ca003ce71535ca4f2775947e1580222",
    name: "chinese-asr",
    title: "中文录音转写与说话人证据",
    status: "已安装 / 正式环境回归通过",
    maturity: "A",
  ...
  skill({
    ...
    sourceBytes: 6555,
    sourceSha256: "ab9f372bc71bf2821d18e747479fa1537ade0ddf253aa4775ff0fa8478ddb66c",
  ...
  skill({
    ...
    useWhen: ["已授权网站操作停在登录页，需要选择 Chrome 已保存账号或继续云端安全登录交接", "需要真实浏览本地 HTML，或本人未另选浏览器时应复用外部 Chrome", "浏览控制内核或受管运行文件缺失，但旧标签页和登录态仍有价值", "表单下拉项依赖前一层异步加载，连续点击会丢状态", "需要逐个上传文件并确认页面真正进入成功态", "点击提交后必须从新生成的平台记录核对字段和附件", "一次跨项目浏览故障已经完成真实恢复，需要判断是否沉淀可复用教训"],
    ...
    sourceBytes: 13908,
    sourceSha256: "ac587d39c5b2b199ca6d6f8fbda04405beacf89343d3b77cae4b0841f75d227f",
    sourceState: "当前 .agents 已发布源码包含登录与已保存账号自动填充指导；本轮仅核对源码、安装和供应事务，运行恢复及历史业务结果仍单列",
    installState: "canonical junction 已安装，source 与 quick validation 通过",
    currentTaskState: "本轮只读核对当前 Skill 与供应，未操作真实账号弹窗、填充凭据或登录网站",
    freshTaskState: "此前自然路由有历史验收；本轮没有新建浏览会话验收当前安装恢复",
    evidenceObservedAt: "2026-09-14：中国时间；.agents f186fc46 的 Skill 源码与供应只读核对，历史恢复、上传和提交保留原日期",
    evidenceBasis: ".agents main f186fc46 的浏览 Skill 与既有 helper 合同、个人供应 source/install/transaction；本轮未做真实登录、填充、上传或提交，不把已安装或 ready 当成端到端通过",
  ...
  skill({
    ...
    sourceBytes: 9401,
    sourceSha256: "35e5c5336ca0e0cef221c196d7fcaed6549adeb5de6fb1a2d8579ffca6001046",
