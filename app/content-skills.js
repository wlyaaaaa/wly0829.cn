...
export const skills = [
  ...
  skill({
    ...
    sourceState: "2026-09-12 核对 work-delivery Skill 及按需交付包参考，来源 main 5fde1a5；工作项目 main 7652168 已回读。进度与既有精确授权表述一致，历史合成验收不升级为本轮真实工作证据",
    installState: "canonical junction 已安装并与规范源码一致",
