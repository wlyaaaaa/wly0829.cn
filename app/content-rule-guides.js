  ...
  agents_root_rules: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          item("用户原意高于实现方案", "所有项目、根代理、全部后代、新对话及压缩续作都区分用户目标/更正与可替换方案。模型、计划、代码、测试、草稿和审查不能自造目标、流程、安全/恢复要求或未来需求。"),
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          item("已证依赖缺陷不能被绕过后遗忘", "若 A 的结果依赖 B，而 B 的缺陷确已影响正确性、可靠性或用户可见结果，修好 A 的临时路线并不解除 B 的责任。沿已有授权和 B 的最小施工范围修复或正式交接；未修时对本人说清具体问题、影响、未修原因与接手状态。报告兜底，不代替已授权修复，也不扩大为接管 B 全项目。"),
