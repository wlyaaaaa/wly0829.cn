...
export const codexRemoteProject = {
  order: 34,
  slug: "codex-remote",
  usageEntry: "当前 Codex Remote 控制入口冻结且不可用，不能从手机开始操作；本页只读保留历史设计与证据，恢复须另行明确启动独立项目。",
  usageInputs: ["想了解的历史能力或版本；当前不能操作"],
  title: "Codex Remote",
  ...
  why: "过去，长任务在电脑上继续运行时，手机需要看同一个任务、处理审批和补充要求，不能靠另开聊天复制历史。Codex Remote 曾为此提供手机控制设计；当前控制入口已冻结且不可用，页面只帮助理解历史功能和证据。",
  plainExample: "我现在若问：“电脑上的 Codex 任务还在跑，能不能用手机接着看，再补一句要求？”答案必须先说清：不能。Codex Remote 当前冻结且不可用；这张筛选展示只能让我看懂它过去怎样让手机和电脑共享同一个任务，以及当时留下了哪些证据，不会连接、探测或发送任何东西。",
  result: "现在能得到的是按版本和日期说明的历史产品参考：曾怎样查看同一任务、子任务、审批、文件和更新，以及哪些步骤真正验收过。当前不能登录、连接或执行 Remote。",
  readerStates: {"pass":"历史证据说明手机与电脑曾共享同一任务并完成部分真实操作；今天只可按原版本和日期阅读这些结果。","problem":"旧 Windows 接管方案无法重复、可靠地恢复，所以当前不运行它的重连、补偿或更新流程。","unavailable":"Codex Remote 当前冻结且不可用。只能阅读获准的历史源码、文档和图片；恢复须由本人另行明确启动独立项目并重新做真实验收。"},
  productPrinciples: [
    ...
    { title: "新版本准备好，不等于电脑已经换过去", detail: "新构建先成为可检查、可撤回的候选；手机页面可以在不打断任务时更新，底层任务连接变化必须另外明确交接。" },
  ...
  responsibilities: ["历史上让手机查看并继续电脑上的同一任务，而不是复制一份新聊天。","展示运行时允许公开的回复、进度、工具和文件活动。","把运行中、已结束或归档的子任务放在同一父子结构里查看。","在手机处理真实提供的审批，并把当前轮补充、停止和下一轮草稿分开。","从实际运行时读取可选模型、权限和额度，不用演示值充当当前状态。","分开处理登记项目内的任务和本人电脑文件，覆盖与删除各有明确选择。","通过已认证的手机入口接入本机任务，不把底层控制服务直接公开。","历史更新方案先登记新版本、再切换兼容组件，失败时保留恢复依据。","断线或操作结果不明时先核对，不自动重复发送或执行。"],
  exclusions: ["不提供远程桌面画面，也不把电脑命令行或底层任务服务直接放到公网。","不显示模型隐藏的完整思考，只展示运行时允许公开的内容。","不会在正在生成的一轮中途换模型或权限；选择留给下一轮。","手机待发草稿未被同一任务接受前，不算电脑任务记录。","子任务只读查看；补充要求回到可控制的父任务转交。","新版本已登记不等于已运行，兼容界面更新也不自动重启底层电脑任务。","审批选项、模型目录和额度未知时就显示未知，不制造可点的假按钮。","公开资料不含密码、会话令牌或已确认敏感的私人值。"],
  glossary: [
  ...
  operatingFlow: [{"title":"当前不能开始操作","detail":"控制入口冻结且不可用；不能打开、探测、连接手机任务或照旧 quickstart 重启。"},{"title":"这里只读历史","detail":"页面解释过去的同任务控制、审批、文件与更新设计，并把截图、测试和版本绑定到原日期。"},{"title":"恢复需新的独立项目","detail":"只有本人另行明确启动后，才重新决定实现并做 Windows 生命周期与真实多端验收。"}],
  components: [
  ...
  usageExamples: [
    { ask: "电脑上的任务还在做什么？", effect: "当前 Remote 冻结且不可用，不能替我查询任务；页面只展示历史产品曾怎样把回复、工作记录、文件变化和子智能体放在同一个任务里。", moduleSlug: "same-task-control" },
    { ask: "两个子智能体分别做到哪一步，完成的那个还能看吗？", effect: "当前不会连接任务树；页面只还原过去怎样查看正在做和已经完成的子任务，再回到父任务继续沟通。", moduleSlug: "subagent-navigation" },
    { ask: "给正在生成的回复补一句要求。", effect: "当前冻结，不会发送这句话；历史产品会先判断它还能否影响当前回复，来不及时就保留给下一轮，而不是投错任务。", moduleSlug: "conversation-control" },
    { ask: "把这条要求放到下一轮，稍后再改顺序。", effect: "当前不会写入或恢复待发队列；页面只解释过去怎样保存、改序和删除下一轮草稿，并防止多端互相覆盖。", moduleSlug: "conversation-control" },
    { ask: "这个命令能不能在手机批准？", effect: "当前不能通过 Remote 批准任何命令；历史界面只在运行时真的提供某个选择时显示按钮，缺选项就停下来。", moduleSlug: "models-approvals-context" },
    { ask: "下一轮换模型并继续。", effect: "当前冻结，不查询或修改模型设置；历史设计只会影响下一轮，不把正在生成的回复半途切换。", moduleSlug: "models-approvals-context" },
    { ask: "手机查看刚才改了哪些文件。", effect: "当前不会读取真实文件；页面只保留历史工作记录、差异预览和获准图证，用来说明当时做成过什么。", moduleSlug: "projects-files-input" },
    { ask: "从手机给任务添加电脑里的文件。", effect: "当前冻结，不浏览或引用电脑文件；历史设计会把一次选择限制在短时间和明确文件上，避免变成长期公开链接。", moduleSlug: "projects-files-input" },
    { ask: "手机为什么能看到 Desktop 的实时进展？", effect: "页面只读解释过去怎样让手机和电脑共享同一个任务事实；当前不连接任何服务，也不是远程桌面，更不承诺某种刷新速度。", moduleSlug: "shared-realtime-architecture" },
    { ask: "怎样更新 Codex Remote，又不打断电脑上正在跑的任务？", effect: "当前连状态检查、打开、更新和回滚都在冻结范围；页面只解释历史更新设计，恢复必须由用户另行启动独立项目，不能照旧教程再试一次。", moduleSlug: "installation-update-rollback" },
    { ask: "公网入口会不会直接暴露电脑文件和底层任务服务？", effect: "页面只解释历史登录、请求来源和短时文件授权怎样挡住越界访问；当前入口冻结，不登录、不探测，也不接触真实文件。", moduleSlug: "security-public-access" },
    { ask: "网页断线后会不会重复发送？", effect: "历史设计会先核对那句话是否已经被同一任务接收，结果不明就停住并保留草稿；当前冻结，不会实际连接或恢复队列。", moduleSlug: "conversation-control" },
    { ask: "Codex Remote 以前跑通过，能说明现在在线吗？", effect: "不能。历史版本、测试和真实成功会分别保留，但当前控制入口明确冻结且不可用，不能靠在线探测或旧证据把它改写成现役。", moduleSlug: "versions-evidence" }
  ],
  evidenceLayers: [
  ...
  evolution: [{"date":"2026-07-25—07-27","title":"先让手机接进电脑上的同一个任务","commit":"ed801f5–352e14d","result":"建立了同任务查看、手机控制、审批和待发消息的早期产品，并形成 v0.1.0/v0.1.1 基线。"},{"date":"2026-07-31—08-01","title":"从看进度，扩展到控制、排队和文件工作","commit":"b6988c5–4ef151d","result":"补齐长对话、当前轮补充与停止、下一轮排队、动态审批和选定文件操作；断线及多端修改时会先核对。"},{"date":"2026-08-02","title":"移动体验、父子任务和可回滚发行一起成形","commit":"df9ff3c–c3a0771","result":"扩展手机界面、父子任务查看与历史记录，兼容页面更新有了分段切换和失败恢复设计。"},{"date":"2026-08-02—08-06","title":"继续收紧共享所有权与运行代，但恢复仍未闭合","commit":"e7949b6–94f1cfa","result":"进一步限制同任务身份与安装版本的关系；公开源码继续演进，正式发布仍停在 v0.1.5，现行 Windows 接管恢复尚未达到可重复验收。"}],
...
export const codexRemoteModules = [
  {
    ...
    usageEntry: "当前 Codex Remote 控制入口冻结且不可用，不能从手机开始或恢复任务。本页只能阅读历史设计；恢复须由用户另行明确启动独立项目。",
    usageInputs: ["想了解的历史同任务场景；当前不能连接"],
    productFlow: [{"title":"当前只读看历史","detail":"页面说明过去怎样认准电脑上的同一任务，不发起连接。"},{"title":"理解当时的门槛","detail":"历史设计要先证明电脑端已接上任务，手机才允许发第一条要求。"},{"title":"恢复另做验收","detail":"当前不创建或恢复任何任务；未来新项目必须重新证明两端确实共享同一任务。"}],
    shortTitle: "同一任务",
    ...
    why: "只把聊天记录复制到手机，不能证明手机看到的还是电脑上的同一个任务。旧设计必须先核对任务身份和电脑端是否已经接上，再允许第一条手机要求。",
    example: "我想从手机接着电脑上的同一个任务，而不是另开一份聊天。历史设计会先确认手机看到的任务已经在电脑端落稳，才放行第一条要求；当前 Remote 仍冻结不可用，本页只解释这个防重复机制，不创建或连接任务。",
    result: "历史资料能说明当时如何保持同一任务；当前 Remote 不能连接电脑、开始新任务或继续旧任务。",
    readerStates: {"pass":"历史上，手机和电脑确认是同一个任务后才允许交互；当前只读查看这份证据。","problem":"旧设计遇到断线或重复请求会先核对原任务，不自动另开；当前不会做运行态查询。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "历史版本曾让手机继续桌面同一个任务；当前控制入口冻结不可用，本页只能查看设计和旧验收。"
  },
  {
    slug: "subagent-navigation",
    usageEntry: "当前入口冻结且不可用，不能在手机打开真实任务树；只能阅读本页保存的父子任务界面设计。",
    usageInputs: ["想了解的历史父子任务查看场景；当前不能打开"],
    productFlow: [{"title":"读父子关系","detail":"历史界面从父任务列出子任务、状态和未读完的分页。"},{"title":"读子任务结果","detail":"过去可只读看公开消息、工具与文件活动，补充要求仍回父任务转交。"},{"title":"当前停在说明","detail":"本页不连接任务树；未来恢复要核对完整历史及返回父任务的位置。"}],
    shortTitle: "子智能体导航",
    ...
    example: "我想看看两个子智能体各自做到哪一步。历史界面允许我从父任务点进已完成项，核对消息、工具和文件变化，再回父任务补充要求；当前只能从静态材料理解这段旅程，Remote 冻结不可用，不加载任务也不发送消息。",
    result: "历史资料说明怎样在父任务下查看运行中和已结束的子任务；返回父任务的页面路径曾受测，准确回到原阅读位置仍是单独缺口。当前不能打开真实任务树。",
    readerStates: {"pass":"历史上，父子关系和已读完的历史都能确认时才显示完整任务树；当前只读材料。","problem":"旧设计会把尚未读完的历史明确标为不完整；当前不会连接补页。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "保留父子任务与完整历史导航的设计和测试；当前不连接任务树，返回原阅读位置仍缺独立验收。"
  },
  {
    slug: "conversation-control",
    usageEntry: "当前入口冻结且不可用，不能发送 steer、interrupt 或下一轮队列；本页只解释旧设计中三种动作如何区分。",
    usageInputs: ["想了解的历史当前轮或下一轮动作；当前不能发送"],
    productFlow: [{"title":"先分清想影响哪一轮","detail":"历史设计把给当前回复补要求、停止当前回复和留给下一轮分开。"},{"title":"有结果才确认发送","detail":"两端同时改草稿或传输中断时先核对原任务，不能自动重发同一句话。"},{"title":"当前没有发送入口","detail":"冻结期间本页不会投递、排队或恢复任何文字。"}],
    shortTitle: "对话控制",
    ...
    example: "我在手机上补一句“先别改配置，只分析原因”。历史产品会先判断这句话还来得及影响当前回复，还是应该排到下一轮；断线后结果说不清就停住，不会自动重发。当前 Remote 冻结不可用，这里只展示这套处理逻辑，不发送文字或恢复队列。",
    result: "历史设计分清当前补充、停止与下一轮待发，并在断线时避免重复发送。当前没有任何文字会通过 Remote 发出或排队。",
    readerStates: {"pass":"历史上先核对目标任务、正在进行的轮次和本人选的动作，再发送并看接收结果。","problem":"旧设计遇到多端修改或回执丢失会先保留草稿核对；当前不恢复或重放队列。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "历史版本曾区分当前轮补充、停止与下一轮排队；现在这些控制与队列恢复都不可使用。"
  },
  {
    slug: "models-approvals-context",
    usageEntry: "当前入口冻结且不可用，不能用手机改模型或批准命令；只可阅读历史模型、审批和额度界面合同。",
    usageInputs: ["想了解的历史模型或审批场景；当前不能修改或批准"],
    productFlow: [{"title":"历史先读运行时","detail":"原设计从真实线程和模型目录取得可选项，不能写死演示列表。"},{"title":"历史按时机应用","detail":"模型和模式选择属于下一轮；审批只有运行时给出选项才可提交。"},{"title":"当前不作效果承诺","detail":"冻结期间没有实时审批或额度查询，旧截图也不证明今日状态。"}],
    shortTitle: "审批与上下文",
    ...
    statusTone: "problem",
    value: "历史手机界面会从电脑的实际任务读取模型、额度与审批选项；当前不能通过 Remote 查看账号或批准命令。",
    why: "把一个默认模型、0%用量或固定‘允许一次’按钮写死，会让界面看起来完整却与实际运行时不一致；同一轮热切换参数还会产生无法解释的中间状态。",
    example: "我想在手机上把下一轮换成另一个模型。历史产品只会保存下一轮的选择，不把正在生成的这一轮半途换脑；当前 Remote 冻结不可用，不查询模型目录，也不把旧截图里的选项说成现在还能选。",
    result: "可阅读过去怎样区分当前参数、下一轮选择和真实审批；旧截图中的模型或额度不是今天的可用列表。",
    readerStates: {"pass":"历史上，当前任务设置与下一轮选择分别可读，不会中途换正在生成的回复。","problem":"旧设计遇到缺少模型或审批选项会显示未知，不制造可点的按钮；当前不请求这些数据。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
      "当前参数和下一轮选择使用不同字段。",
    ...
    readerStatus: "保留模型选择、审批和额度显示的历史实现；当前不查询目录或提交审批，旧截图不是现行选项。"
  },
  {
    slug: "projects-files-input",
    usageEntry: "当前入口冻结且不可用，不能在手机浏览、上传或修改电脑文件；本页只保留历史文件工作台范围。",
    usageInputs: ["想了解的历史项目或文件场景；当前不能读写"],
    productFlow: [{"title":"历史先选根","detail":"原设计按登记项目或隔离无项目工作区限定文件范围。"},{"title":"历史逐文件确认","detail":"预览、上传、编辑、移动和删除曾要求具体路径及覆盖选择，并在动作后重新列目录。"},{"title":"当前无文件动作","detail":"冻结期间不读真实文件，也不因历史记录推断临时文件还能取回。"}],
    shortTitle: "项目与文件",
    ...
    statusTone: "problem",
    value: "历史产品把“这个任务属于哪个项目”和“本人能管理哪些电脑文件”分开；当前手机文件工作台冻结，不能浏览或改文件。",
    why: "项目任务需要防止根目录被替换或越界；所有者文件管理又不能因为任务不在某个项目里就失去用户本来拥有的磁盘权限。把两者混在一起会既不安全又不好用。",
    example: "我想从手机把另一块磁盘上的文件加进任务，目标位置却已有同名文件。历史产品会停下来让我明确是否覆盖；当前 Remote 冻结不可用，本页只展示当时的文件边界和图证，不浏览、上传、复制或删除任何真实文件。",
    result: "可阅读旧版文件范围、覆盖确认与删除边界；当前不会从手机读取、上传、移动或删除任何真实文件。",
    readerStates: {"pass":"历史上，选定项目、文件位置和覆盖选择都确认后才执行文件动作。","problem":"旧设计遇到同名文件或被占用文件会停下交回实际结果；当前不查询文件。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
      "任务项目根和所有者文件根使用不同身份。",
    ...
    readerStatus: "保留手机文件工作台与项目边界的历史验收；当前文件浏览、上传和修改入口随Remote一起不可用。"
  },
  {
    slug: "shared-realtime-architecture",
    usageEntry: "当前入口冻结且不可用，不能连接 Browser、Sidecar、Broker 或 app-server；本页仅解释历史任务事件怎样抵达手机。",
    usageInputs: ["想了解的历史手机与电脑同步方式；当前不能连接"],
    productFlow: [{"title":"看过去的同任务通路","detail":"历史手机入口先验证登录，再通过本机共享组件读取电脑任务的公开进展；底层控制服务留在本机。"},{"title":"断线时重新确认","detail":"旧设计按任务真实记录续接，不能靠相似标题猜这是同一个任务。"},{"title":"当前不建立连接","detail":"架构说明不证明今天在线，也不提供实时刷新。"}],
    shortTitle: "共享架构",
    ...
    why: "手机与电脑必须共用同一个任务来源，又不能把本机底层控制服务直接放到公网；旧设计通过受控入口传递整理后的进展。",
    example: "我问“为什么手机和电脑当时能看到同一个任务进度？”历史链路只让公网入口接触经过整理的产品事件，真正的任务连接留在本机并由两端共享。当前 Remote 冻结不可用，这只是架构说明，不包含刷新速度承诺，也不会打开地址或建立监听。",
    result: "历史材料能解释手机为何看到同一任务进展及断线时怎样重读；当前不会建立任何连接，也不承诺实时刷新速度。",
    readerStates: {"pass":"历史上，手机入口和电脑确实连到同一任务来源时，才显示持续进展。","problem":"旧设计遇到事件缺段会重新读任务真实状态；当前不启服务补证。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "保留手机和桌面共享任务进展的架构及重连测试；当前没有可用控制链，本页不建立连接。"
  },
  {
    slug: "installation-update-rollback",
    usageEntry: "当前入口冻结且不可用，不能执行 Status、Open、Close、安装、更新或回滚；要恢复必须由用户另行明确启动独立项目。",
    usageInputs: ["想了解的历史安装或回滚版本；当前不能执行"],
    productFlow: [{"title":"先承认当前不能操作","detail":"这里只读解释旧版本怎样准备和采用；检查状态或重装都不在当前范围。"},{"title":"分清旧版本的几个结果","detail":"新文件登记、电脑选择采用和实际进程切换是不同事实，不能用一个回执代替全部。"},{"title":"恢复要另起项目","detail":"本人明确启动后才重新定方案，并做 Windows 生命周期和真实手机端到端验收。"}],
    shortTitle: "安装与回滚",
    ...
    statusTone: "problem",
    value: "历史更新方案会先保存可识别的新版本，再选择何时采用，并保护电脑上正在做的任务。当前只能阅读这些设计，不能按旧步骤安装、更新或回滚。",
    why: "直接覆盖运行中的文件会让旧版本和恢复位置说不清，也可能中断电脑任务。旧设计把准备新版本、采用和底层切换分开。",
    example: "我问“能不能先检查一下状态，再把 Remote 恢复起来？”当前答案仍是不可以：状态检查、打开、更新和回滚全在冻结范围。页面只能从发布材料和源码还原旧设计；真正恢复必须另开一个明确项目重新验收，不能从这里顺手试一次。",
    result: "得到历史版本和回滚依据的说明，以及现行接管方案为什么停止；当前不能据此恢复运行。",
    readerStates: {"pass":"历史代码证明曾有版本检查和回退设计；这不是当前已安装或可运行的证明。","problem":"旧 Windows 接管仍缺可重复恢复验收，所以不能用“再试一次”代替修复。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "保留安装、更新和回退的历史实现；Windows接管尚未达到可重复恢复要求，当前不执行安装或恢复。"
  },
  {
    slug: "security-public-access",
    usageEntry: "当前入口冻结且不可用，不能登录公网手机入口或执行审批与文件操作；本页只能了解历史防护边界。",
    usageInputs: ["想了解的历史登录或访问边界；当前不能登录"],
    productFlow: [{"title":"历史先登录","detail":"旧设计在产品动作前核对密码、短时会话、来源和防重复身份。"},{"title":"历史逐请求校验","detail":"审批和文件动作各自绑定具体目标，过期时不再执行。"},{"title":"当前不访问","detail":"冻结期间没有可用登录会话；文档与威胁模型不能当现时公网安全验收。"}],
    shortTitle: "安全接入",
    ...
    example: "假如手机浏览器已经登录，另一个网页偷偷诱导它去删电脑文件，历史请求守卫仍会因为请求来源对不上而拒绝。当前 Remote 冻结不可用，本页只解释当时的保护边界，不登录，也不向任何端点发验证请求。",
    result: "可读懂旧版手机入口怎样检查登录、请求来源和具体目标；当前没有可登录或可执行的公网入口。",
    readerStates: {"pass":"历史上，身份、会话、请求来源和目标都通过时才执行手机动作。","problem":"旧设计会拒绝重复、过期或来自其他网页的请求；当前不做在线安全探测。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "保留登录、请求来源和文件操作保护的历史设计；当前不提供公开登录或控制入口。"
  },
  {
    slug: "versions-evidence",
    usageEntry: "当前只能只读查看获准的 Codex Remote 源码、文档、测试与历史图片；不能探测运行态，也不能按旧 quickstart 启动。",
    usageInputs: ["想核对的历史版本或图片；当前只读"],
    productFlow: [{"title":"绑定历史版本","detail":"把功能、测试和截图分别对应到当时版本及观察日期。"},{"title":"分开解释证明力","detail":"测试通过和真实旧截图说明曾做成的范围，不能证明现在在线或 Windows 接管可重复恢复。"},{"title":"停在准确结论","detail":"网页报告当前不可用与冻结；未来只有本人明确重启独立项目才重新取证。"}],
    shortTitle: "版本与证据",
    ...
    example: "我问“它以前通过那么多测试、手机也真跑通过，能不能算现在仍在线？”答案是否定的。那些证据只证明对应版本和当时场景；当前 Remote 已明确冻结且不可用，不能把历史成功翻译成现役状态，更不能为了补证去做在线探测。",
    result: "按版本和日期分清哪些历史功能真正做成过、哪些只在测试中通过，以及当前仍冻结不可用。",
    readerStates: {"pass":"历史结论与相应版本、日期和真实证据一致时，才写明那一层通过。","problem":"源码、正式发布和截图时间不一致时分别展示，不用新提交覆盖旧版本事实。","unavailable":"当前控制入口冻结且不可用，只能阅读获准的历史材料；恢复须由本人另行明确启动独立项目并重新验收。"},
    decisionImpact: [
    ...
    readerStatus: "正式旧版本和当时真实成功的证据仍可查看；当前入口不可用，恢复需明确的新任务和重新验收。"
  }
];
