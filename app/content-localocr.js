...
export const localOcrModules = [
  ...
  },
  {
    ...
    example: "我可以问：“这台新电脑只有源码，怎样把 LocalOCR 恢复到真正能读文件？”系统会先核对 Windows、Linux 子系统和显卡条件，再安装依赖与所选模型，并分别运行基础检查和一个真实小样例；缺什么就明确停在哪一层。",
