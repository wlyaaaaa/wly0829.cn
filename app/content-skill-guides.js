...
export const skillGuides = {
  ...
  "personal-litigation": guide([
    ...
    ["presumed completed（推定本人已操作）", "用户明确决定继续并拿到可提交成品、此后又没有取消或失败反馈时，用来避免重复动作的可逆判断；它不是平台或机构回执。"],
    ...
    ["只有可提交成品，没有平台回执", "不重复提交，也不写成机构已受理。", "保留成品与本人操作的独立状态，下一步只做现实回读。"],
...
export const skillOutcomes = {
  ...
  "documents": {
    value: "让我得到真正可编辑、版面可靠的 Word 文书：不仅文字正确，还逐页检查裁切、重叠、字体、表格、页眉页脚、修订和批注，避免把能打开的 DOCX 误当成可交付成品。",
    ...
    changes: ["新文书先按用途选择结构和一致样式。", "现有文书优先做最小局部编辑并保留原结构。", "每个有意义编辑批次后重新渲染全部页面。", "修订、批注、表单和字段同时做结构与视觉检查。", "bundle 版本只记录观察来源，不成为未来准入。"]
  },
  "pdf": {
    ...
    changes: ["读取内容时同时保留页码、表格、图和脚注关系。", "交互表单同时核对字段树、Widget、逻辑值和外观流。", "默认保留交互性，只有明确要求才压平。", "每次有意义更新后重新渲染并检查全部页面。", "bundle 版本只记录观察来源，不成为未来准入。"]
  },
  "md-to-pdf": {
