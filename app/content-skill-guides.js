...
export const skillOutcomes = {
  ...
  "document-materials": {
    value: "让我围绕当前材料状态和可靠原件制作真正可用的文书与材料包，并把文件制作、本人操作、平台接收和接收方处理分开，避免漏掉期限、丢失恢复点或重复操作。",
    why: "同一份材料可能同时存在草稿、已核对成品、本人操作结果、平台记录和接收方处理结果。把这些层混在一起，最容易把文件生成当成现实进展，或在中断后重复制作和重复提交。",
    example: "例如我说“把这份合同修订成正式版，再把说明和附件整理成提交包”。它先核对当前材料状态、原件、证据、期限和接收要求，再完成正文、附件、分页与逐页验收。",
    result: "我会得到可实际使用的合同、正式说明、申请材料、事件材料或提交包，以及明确的下一步和恢复点；材料已生成、本人已操作、平台已收到、接收方已处理会分别说明。",
    ...
    changes: ["先读取当前材料状态，再只打开会改变判断的最小原件。", "合同起草修订、正式说明、申请材料、事件材料和提交包按各自用途制作，不声称五类场景已经全部完成端到端验收。", "内容完成后逐页检查格式、附件、签署位置与证据对应关系。", "材料已生成、本人已操作、平台已收到、接收方已处理逐层区分。", "本人明确决定继续、已取得完成核对的可使用成品，且后来没有取消、未操作、失败、撤回或延期反馈时，才按可撤销惯例避免重复操作。", "只有可使用成品而没有现实回读时，本人是否已操作保持 Unknown（未知）。", "中断后从最近一次已核对成品和状态恢复；实质修改后重新完成内容、格式与证据验收。", "提交、付款、撤回和联系外部接收方必须有精确授权。"]
  },
  "work-delivery": {
    value: "让我把一个会持续变化的工作事项做成真正一致的交付包：需求、会议记录、规则和表格中的事实只确认一次，PRD、评审材料和执行表都从同一事实版本生成；来源变化时只处理受影响部分。",
    why: "手工分别改 PRD、PPT 和跟踪表，很容易出现日期、负责人、范围、指标和验收口径互相矛盾。更常见的问题是来源改了，却没人知道哪些旧成品已经过期。",
    example: "例如我明确选择需求说明、会议纪要和一张指标表，要求做 PRD、评审材料和执行表。它先指出三份来源里的事实、冲突和缺口；确认后从同一事实版本生成三类成品。后来会议纪要更新时，它只告诉我受影响的事实和成品。",
    result: "我会得到来源覆盖、已确认事实、未解决冲突、跨产物一致的正式文件、追溯清单和变更影响；若关键事实或验收条件缺失，只得到明确标记的待确认草稿和一个需要决定的问题。",
    ...
    changes: ["只有用户明确选中的来源进入交付包。", "事实、假设、冲突和未知分开确认。", "PRD、评审材料和执行表绑定同一事实修订版。", "来源变化后旧构建标记过期，并只列受影响事实。", "一次性单文件编辑绕过本项目。", "未授权的发送、审批、邀请和外部修改不执行。"]
  },
  "documents": {
