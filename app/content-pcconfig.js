...
export const pcconfigModules = [
  ...
  },
  {
    ...
    decisionImpact: [
      ...
      "电脑日常小故障沿现有精确入口处理：微信只补健康实例，音频只选择已登记目标，卡住的修饰键只释放按键；鼠标主题被系统悄悄重置时自动恢复，守护进程退出后原任务补启；本人改选主题或恢复Windows原生方案时退出。显示拓扑恢复和 Xiaomi Share 看门狗各保留独立开关与回读。主屏 OLED 黑屏工具只是等待稳定版的历史恢复点，已知输入法/屏保闪烁未被网页更新消除，不能据旧源码自动安装或覆盖。",
  ...
  },
  {
    ...
    verification: [
      ...
      "2026-09-12实际任务Ready，09:00/21:00触发、S4U/Highest、writer_activated、普通胶囊7天/2代；独立自动化“副电脑恢复胶囊每周语义巡检”为ACTIVE、gpt-5.6-luna/max、周一10:00。调度、自然备份和历史隔离恢复是三类独立证据。另发现旧周检模板仍只允许三条Funnel映射，与已授权六条冲突；来源Owner已将该口径修正为按正式账本、受保护运行时和relay登记逐项匹配，随21a0fbd发布；副机安装模板及自动化正文尚未回读，不能由ACTIVE调度推定已部署。",
