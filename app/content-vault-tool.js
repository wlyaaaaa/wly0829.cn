...
export const vaultToolProject = {
  ...
  cardStatusTone: "pass",
  ...vaultToolSnapshot,
  searchAliases: ["vault-tool", "本地文件加密", "加密保险库", "文件加密后怎么取回来", "密文备份", "密码保护文件夹", "第18项目"],
  ...
  plainExample: "在装有 vault-tool 的电脑上，我可以向 AI 说：“把这三个明确指定的文件准备成加密备份，保留原来那份库里的其他文件；密码我在本机输入。以后只想找清单时，不要把全部附件解压出来。”AI 先确认是追加而不是整库替换，再打开相应本地入口；网页本身没有上传框或密码框。",
