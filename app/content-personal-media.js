...
const SOURCE_MAIN_COMMIT = "22a6109b7ef787a98d97069884d3e5166316b09a";
const current = Object.freeze({
  observedAt: "2026-09-18T12:59:46Z",
  catalogRows: 4358,
  visualRows: 3601,
  imageRows: 3485,
  videoRows: 116,
...
const personalMediaSnapshot = createProjectSnapshot({
  observedAt: "2026-09-18T12:59:46Z",
  label: "3,485张照片、116个视频与757项音频；支持具名相册，云端与手机结果分别验收",
  boundary: "媒体数量与目录完整性沿用9月18日观察：4358条本地登记，包括3485照片、116视频、754录音与3项音乐/铃声。本地synced不等于远端再次回读；9月13日云端和播放记录保留原日期。9月22日只合入已发布协作合同，未重读目录、原件或云端，手机回写与当前播放仍未验。",
  metrics: [
    { label: "照片", value: "3,485张" },
    { label: "视频", value: "116 个" },
    { label: "音频", value: "754录音 + 3音乐/铃声" },
    { label: "云端登记", value: "4,358项已映射 · 当前播放另验" }
  ],
  facts: [
    { label: "当前本地整理结果", value: "当前本地目录4358条，仍由照片、视频和音频原件根分别保存。新增具名照片相册是可重建的选择关系，不改变原件分类、不另存第二份图片库；相册用于手机恢复组织与云端关系计划，实际写回和上传另行执行。" },
    { label: "正式源码与当前阶段", value: "9月22日已回读PRIVATE main 22a6109b7ef787a98d97069884d3e5166316b09a；本次增量仅为AGENTS.md与USER_REQUIREMENTS.md的个人更新协作合同。相册和目录仍沿09e8efb、ba43b4c及9月18日已核对材料，未新建采集器或重跑私人媒体流程。" },
    { label: "当前目录与音频角色", value: "2026-09-18只读目录4358条：3485照片、116视频、757音频，其中754录音和3项音乐/铃声，后两类各自数量仍Unknown。SQLite quick_check=ok及根可达，只证明目录状态和来源可见，不证明所有原件逐一存在或重新哈希。", hero: false },
    ...
    { label: "上次已核对手机包与云恢复集", value: "当前2245项、43,010,158,632字节（43.01十进制GB），低于60GB；云恢复集照片视频2382项/74.47GB，连音频3139项/94.60GB，完整云保留集4230项/96.18GB。云恢复集是云对象的分类集合，不是重复上传一份ZIP。", hero: false },
    { label: "上次完整云端回读（9月13日）", value: "来源Owner于9月13日23:21Z完成最终全量零写回读：Photos3357图片+116视频共76,049,921,114字节，Drive754录音+3音乐/铃声共20,129,267,708字节；合计4230项、96,179,188,822字节。Photos已登记ID均可读、9相册关系一致；Drive完整分页核对ID/SHA-256/大小/父目录一致。" },
    ...
    { label: "GitHub 私有仓库", value: "PRIVATE wlyaaaaa/personal-media，默认main；本轮已发布源码22a6109b7ef787a98d97069884d3e5166316b09a。源码与元数据由Git保留，原件、云对象和手机文件仍各有恢复来源；资料规模保留9月18日观察。", hero: false },
    { label: "私人版本保存什么", value: "当前metadata/current.zip保存4358条目录及cloud-state.json。对desired=1对象的只读聚合为Photos3485图片/116视频、Drive757音频，合计98,570,051,909字节，全部本地state=synced；历史退出行不计当前集合。Photos最新对象记录9月15日07:31Z，provider记录07:48Z；这些是来源保存的本地状态，不是本网页重新访问云端。" },
    { label: "验收", value: "9月13日102项测试及独立审查只属当时版本；9月18日曾核对新增相册源码、测试定义与已提交元数据。9月22日本轮只读取已发布协作约定，没有重跑测试、模型、上传、照片筛选或手机流程；历史55项验收与画廊保持原日期和字节。", hero: false },
    { label: "历史恢复点指纹（2026-09-05）", value: `${HISTORICAL_SOURCE_RECEIPT} completed=${HISTORICAL_OBSERVED_AT}，SHA-256=${HISTORICAL_SOURCE_RECEIPT_SHA256}；catalog=2268d65ca0ce83c4cc7157dd3346993bbd01863fa6eb9bc8dc7e966f41e38636，seed=7745e2a9fbe7872b51f1e0d751436c1aaba694077e6209f8360b21ab339f78f0，phone-plan=3f406f31af445ac2226ff61a33c87df7f0758a2a555cb2513954f5746b85ba7a，cloud-plan=d897ab66d54baae235831ce30359030e5a3c5f1621af2430684e7cea805fb607。以上摘要仅定位2026-09-05那一代目录、种子和计划，供选择该历史版本时核验；不与现行4358条或当前Git源码互证，不在本轮再次声明旧七文件一致。`, hero: false },
    ...
    { label: "现有每日备份关系", value: "现有PersonalDataReplica-Hot-Daily维护两库sync-current、E→G镜像与recovery-sync；H按现行备份保留规则跟随G有效保留集，原件/媒体包的实际完成只由备份Owner回执证明。媒体主映射与专用Packages恢复路径分别负责，单一映射成功不覆盖其他路径。当前最终媒体状态三盘证据见备份回执，不连接手机或调用云端。", hero: false },
  ...
  gaps: [
    ...
    "9月13日全量云回读曾有1段视频PROCESSING；9月18日本地映射观察未取得新平台处理或播放回执，9月22日本轮也未访问云端。当前播放继续Unknown，不据旧记录断言仍在处理中。",
...
const personalMediaProject = {
  order: 1,
  slug: "personal-media",
  usageEntry: "直接告诉 AI 想找哪张照片、哪段录音，或说明要处理一批本地、手机或云端媒体；实际保全和同步使用项目已有入口。",
  usageInputs: ["记得的地点、时间、画面或录音话语", "整理时要处理的文件和保留选择", "手机或云端工作的目标设备与期望范围（扩大授权时才另行确认）"],
  title: "个人媒体整理与恢复",
  route: "/projects/personal-media",
  visibility: "GitHub 私有仓库",
  repositoryUrl: null,
  statusTone: "mixed",
  cardStatus: "照片新增至3,485张；具名相册可组织恢复，实际播放与手机回写另验",
  cardStatusTone: "mixed",
  ...personalMediaSnapshot,
  kicker: "找到照片和录音，让手机资料安全往返",
  searchAliases: [
    "个人媒体整理与恢复",
    "找照片视频录音",
    "按地点找旅行照片",
  ...
  repositoryNote: "PRIVATE wlyaaaaa/personal-media，main 22a6109b7ef787a98d97069884d3e5166316b09a。9月22日仅补入已发布协作合同；Git保存源码和可恢复元数据，不保存全部原件。媒体数量、相册、云对象、播放与手机结果保留各自原观察日期，现有画廊不变。",
  summary: "我可以按记得的时间、地点或画面查找照片，也能按录音里的一句话找回原文件。选中照片可归入具名相册，手机新文件先两盘保全再精确清理。未限定来源的个人更新也会查看本批媒体变化，不重扫未变全库；分类、手机恢复、云端与后续资料承接分别交代结果。",
  ...
  result: "查找时得到少量仍能打开的照片、视频或录音及匹配理由；整理时得到本批保留、分类或相册结果。手机恢复包、真正写回手机和云端对象各自报告。现有目录和云端映射有已记录的数量与日期，但本页没有把本地“已同步”当成今天远端播放、手机回写或从零恢复成功。",
  readerStates: {
    "pass": "查找交回现存原件；整理、手机双盘保全、恢复包和获准云端同步按各自完成步骤报告，实际手机回写另行核对。",
    "problem": "重复关系、画面意义、地点或恢复责任说不清时，只把少量争议对象留给人判断，不重做整个媒体库。",
    "unavailable": "原件目录、手机或备份盘暂不可用时，只暂停受影响步骤，保留已经核对的副本与精确缺口；查询不会顺手上传或清空手机。"
  },
  stateLabels,
  methodCanvas: {
    "kicker": "个人媒体怎样从线索走到结果",
    "headline": "找到真实原件，判断留下什么，再分别完成保全和恢复",
    "description": "找回一张照片、整理一批新增、保全手机和同步云端是不同任务。它们围绕同一批真实文件工作，但各自交付可核对的结果。",
    "steps": [
      {
        "actor": "已给出的线索",
        "title": "缩小到相关的照片、视频或录音",
        "detail": "按记得的地点、描述、类别或时间查找；拍摄地点和画面上写着的地名分开看。"
      },
      {
        "actor": "现存原件",
        "title": "交回少量可打开的候选",
        "detail": "先核对文件仍在。需要一起看时才做临时浏览入口，结束后清理入口，不动原件。"
      },
      {
        "actor": "单个本地新增",
        "title": "只接入已经看过的一份文件",
        "detail": "确认内容、类别和时间，再放入照片、视频或音频的正式位置并核对另一盘副本。同一视频的不同封装先证明等价，避免当新视频重复收藏。"
      },
      {
        "actor": "视觉整理",
        "title": "决定保留、类别和近重复",
        "detail": "把少量图片一起看，比较画面意义、质量和更完整版本；看不清或取舍不明就保留待复核。"
      },
      {
        "actor": "手机新文件",
        "title": "先保全，再精确清理",
        "detail": "把本次新共享文件逐项存到电脑两块盘并读回核对；只清理已核准的手机文件，确认可拔后再在电脑上慢慢整理。"
      },
      {
        "actor": "各自的恢复目标",
        "title": "手机和云端分别确认",
        "detail": "电脑准备手机恢复内容，第二次连接才实际写回；云端按既有授权另行同步并核对对象、相册和播放状态。"
      }
    ],
    "columnsAriaLabel": "用户、个人媒体项目与手机云端之间的责任边界",
    "columns": [
      {
        "title": "用户说明",
        "note": "目的和必要选择",
  ...
  productPrinciples: [
    {
      "title": "原件只有自己的正式位置",
      "detail": "照片、视频和音频仍各在原来的文件目录。查找用的目录只记住怎样找到它们，不另复制一套相册。"
    },
    {
      "title": "精选是选择，不是额外副本",
      "detail": "值得常看的照片可以进精选，没有数量配额；普通视频留在视频目录，本人手筛留下的内容不会因精选标准再被删除。"
    },
    {
      "title": "本人删掉的原件不会被旧副本复活",
      "detail": "文件管理器中的真实原件现状是准绳。后续维护让查找、备份和手机包跟随当前文件；下次连手机时，也先分清本人删除、移动、改名和 AI 曾清空。拿不准就保留。"
    },
    {
      "title": "看懂画面与读出文字各有来源",
      "detail": "画面里的场景和价值靠视觉判断，图片上的字靠文字识别；两类证据一起帮助找回原件，不建立第二个文字媒体库。"
    },
    {
      "title": "公开内容按实际敏感性逐项判断",
      "detail": "普通照片不会因来自个人媒体库就整类排除；私人正文和秘密值仍逐项保护，技术层保留现行公开分级。"
    },
    {
      "title": "本地新增一次处理一份已复核文件",
      "detail": "先确认文件和说明，再实际接入；同一视频的不同容器形式要另证内容等价，不从任意目录自行扩张来源。"
    },
    {
      "title": "录音移动不等于重新识别",
      "detail": "录音和音乐留在各自现行目录，搬动已知文件时沿原内容身份找回已有转写和云端关系，不为改名重新跑识别或上传。"
    },
    {
      "title": "手机分两次连接处理",
      "detail": "第一次先存稳新文件并精确清理，确认可拔后在电脑上分类和准备差异；第二次连接才按手机真实现状写回。云端上传不决定何时拔线。"
    },
    {
      "title": "分类要说出内容意义",
      "detail": "移动到目录不是判断完成；画面意义、质量和近重复关系说不清时保留待复核。"
    },
    {
      "title": "每种结果都要单独收口",
      "detail": "本地目录、备份、手机恢复包、真正写回手机和云端同步分别核对。有依据的本人认识或文件定位交给对应项目，不把一次导入说成全部个人更新完成。"
    },
    {
      "title": "数据安全、清空和回写各是一步",
      "detail": "两盘副本读回后才有可恢复字节；本次精确清空收稳后才告知第一阶段可拔。离线准备和第二次回写不会由保全自动完成。"
    },
    {
      "title": "云端动作只跟随实际授权",
      "detail": "照片留在本地、随手机携带和放到云端是三个选择。既有范围内的正常增量不用每批重复批准；扩大账号或来源另行确认。"
    },
    {
      "title": "小批量工作保持轻量",
      "detail": "一次普通整理尽量快速完成，不为它新建服务或扫描全库；既有小批量速度目标和实际缺口留在技术依据中。"
    },
    {
      "title": "相册把选中的照片组织在一起",
      "detail": "一个具名相册只保存选择关系，不复制照片或改掉原分类；用户确认的地点保留来源，保存相册关系也不自动上传。"
    }
  ],
  responsibilities: [
  ...
  operatingFlow: [{"title": "AI选对应的媒体路线", "detail": "按这次目的进入查找、单文件接入或手机/云端处理。单纯查找只用已有目录，不把找到候选误说成分类、保全或恢复已经完成。"}, {"title": "核对原件与去留", "detail": "搜索返回现存文件；新增先看能否打开、画面意义、质量和重复关系。不确定的先留着，用户已删除的原件不从旧索引复活。"}, {"title": "分阶段完成保全与恢复", "detail": "手机新文件先验证电脑两盘副本，再精确清理并说明能否拔线；电脑离线分类后准备恢复差异。手机写回与云端对象、播放分别回读。"}, {"title": "交付可用结果和缺口", "detail": "返回原件或本批最终保留内容，分别说明目录、恢复包、云端和手机的真实状态。设备不可用时留下已完成部分及继续入口。"}],
  technicalSections: [{ title: "公开分级", paragraphs: ["普通个人照片按活动公开分级属于 L2；页面逐值处理真实 L3+ 与可复用秘密，不因来源是个人媒体库就整类删除。"] }],
  technicalOperatingFlow: [
    { title: "先确定是查找、整理还是个人更新", detail: "查找按用户实际提供的地点、文字、类型或日期缩小范围；拍摄地点与画面上出现的地名分开。未限定来源的个人更新把媒体纳入变化发现，先看已有状态与本批数据，不把一句更新变成全库重扫。" },
  ...
  components: [
    ...
    { name: "catalog.sqlite3", responsibility: "保存可重建的当前媒体定位与检索字段。", implementation: "本次目录4358条，SQLite统一保存定位、分类、检索、具名相册和云对象关系；媒体字节仍由原件与备份保管，历史已退出对象不混入当前期望数量。" },
  ...
  usageExamples: [
    {
      "ask": "找我在新加坡现场拍的照片。",
      "effect": "按已经核对的拍摄地点筛选，返回少量仍存在的原件、已知日期、类别和匹配理由。",
      "moduleSlug": "search-browse"
    },
    {
      "ask": "在刚才选中的录音里，找一下谈到交付时间的那段，告诉我从几分几秒开始。",
      "effect": "先核对同一原音，再复用已有转写时间段，交回起止时间、有限片段与覆盖缺口；没有可用时间戳就明确说明，不能按文字长度猜时间，也不会因查询自动重跑识别。",
      "moduleSlug": "search-browse"
    },
    {
      "ask": "这批截图哪些该留，哪些是重复或没意义？",
      "effect": "先排除缓存并整理重复关系，再用少量联系表一起判断主体、信息价值、画质、类别和是否已有更完整版本。",
      "moduleSlug": "classification"
    },
    {
      "ask": "把这一个已经看过的本地照片、视频或录音接入媒体库。",
      "effect": "核对文件身份、类别和时间后写入正式原件目录与 G 盘恢复副本，并同步更新目录、手机恢复包和未上传的云端候选；同内容的视频变体只保留恢复关系。",
      "moduleSlug": "local-ingest"
    },
    {
      "ask": "我在手机删了旧照片，又拍了新的；下次接上，删留对齐后尽快让我拔线。",
      "effect": "先对照最后真实完整回写，确认本人删掉的受管旧照片/视频退出电脑原件和本地手机包；移动、AI清空或读不到不猜删除。再补齐新增文件两盘副本并精确清空手机，电脑准备和再次连接回写另报；G/H与云端退出单独核对。",
      "moduleSlug": "phone-preservation"
    },
    {
      "ask": "现在手机恢复包能恢复多少？",
      "effect": "只读返回当前计划数量、大小、是否低于 60 GB 和缺口；默认不改包。",
      "moduleSlug": "phone-recovery"
    },
    {
      "ask": "现在Photos和Drive已经存好哪些内容，还有什么没完成？",
      "effect": "预览已选Photos/Drive集合的对象、关系与待办；需要执行时沿已有授权同步并真实回读，已完成对象不重传，播放仍在处理则单列。",
      "moduleSlug": "cloud-candidates"
    },
    {
      "moduleSlug": "classification",
      "ask": "把我选中的这组照片放进一个叫“周末出游”的相册，原来的分类别乱动。",
      "effect": "为选定照片记录相册关系，保留原件与现有分类；可同时记录本人确认的地点和日期，但不伪装成照片原生GPS。手机与云端关系先形成计划，真正写回后再分别回读。"
    },
    {
      "moduleSlug": "classification",
      "ask": "更新一下个人资料，这批新照片和录音也一起看看，已有的别重扫。",
      "effect": "先查看媒体现有状态与本批变化，完成对应保全和整理后，把有依据的本人事实、原件定位和必要识别结果交给各自负责的项目；未完成的手机回写或基础资料承接单列，不把一次导入当整批完成。"
    }
  ],
  evidenceLayers: [
    { layer: "9月18日私有元数据观察", proves: "9月18日读取ba43b4c已提交的目录与云端元数据：本地4358条、desired对象4358条，3485照片/116视频/757音频。这是保留的聚合观察，本轮没有重新读取私人相册、原件或云ID。", doesNotProve: "网页没有导出或还原真实快照；Git保存分类和远端映射，不保存媒体原件，不能由哈希还原照片。" },
    { layer: "项目规则与 README", proves: "既有产品说明定义三阶段手机处理、分类、云执行与查询只读边界；9月22日读取已发布22a6109的AGENTS.md与USER_REQUIREMENTS.md增量，补入一般个人更新及可靠事实/原件定位的既有入口交接，不新增采集器、数据库或后台服务。", doesNotProve: "文字说明不证明当前目录、恢复包或设备在线。" },
    ...
    { layer: "当前云端与恢复Owner结果", proves: "2026-09-13T23:21Z全量云对象/分类回读完成且重复执行零写；备份Owner于9月14日00:15:44Z核对最终媒体状态E/G/H一致。", doesNotProve: "9月13日115 READY/1 PROCESSING仅是当时状态；本地synced不证明当前全部播放、手机回写或云端零起点恢复。" },
  ],
  ...
  evolution: [
    {
      ...
      "title": "先解决想用时找不到",
      "commit": "",
      "result": "照片、视频和录音共用一个可重建目录，按线索返回真实原件，临时浏览不建立另一份原件库。",
      "evidence": [
        {
          "date": "2026-08-23—08-24",
          "note": "形成照片、视频与音频统一查找和临时浏览。 原记录的依据标签为“milestone-01”，未附Git提交编号。"
        }
      ]
    },
    {
      ...
      "title": "手机先安全取出，再慢慢整理",
      "commit": "",
      "result": "增加两盘保全、重复核对和精确清理，分出可拔线节点；电脑继续分类，需要时再生成手机恢复差异。本人删除和整盘不可用始终区别处理。",
      "evidence": [
        {
          "date": "2026-08-25",
          "note": "手机新增文件先完成两盘保全，再明确可拔线节点。 原记录的依据标签为“milestone-02”，未附Git提交编号。"
        },
        {
          "date": "2026-08-26—08-27",
          "note": "分类、近重复治理和恢复包范围分开，目录可重建。 原记录的依据标签为“milestone-03”，未附Git提交编号。"
        },
        {
          "date": "2026-08-30",
          "note": "当时云端只生成未上传候选；该历史边界不能代替后续已获准的同步能力。 原记录的依据标签为“milestone-04”，未附Git提交编号。"
        }
      ]
    },
    {
      "date": "2026-09",
      "title": "查找、筛选与云端保全分开协作",
      "commit": "",
      "result": "录音可定位已有转写片段，图片按画面和必要OCR文字检索，精选入口不设配额；云端从本地候选发展到获准同步，实际对象、播放就绪、手机包与手机回写分别验收。",
      "evidence": [
        {
          "date": "2026-09-02—09-14",
          "note": "录音片段定位、六类图片入口、音频归位与手机三阶段形成；首轮云对象已有回读，实际播放与手机回写仍分别验收。",
          "commit": "ba43b4c9fdef18a51e8165944fe807e7b76bd43c"
        }
      ]
    },
    {
      "date": "2026-09-15–09-18",
      "title": "选定照片可以组织成相册",
      "commit": "22a6109",
      "result": "具名相册保存选择关系，不复制第二份原件或改掉原分类；新媒体与其他个人项目之间只回写各自负责的认识和结果，不建立中央资料副本。"
    }
  ],
  galleryPresentation: {
  ...
  "readerBoundary": "当前记录为3,485张照片、116个视频、754份录音及3项音乐／铃声；统计、云映射、实际播放与手机回写各有观察范围。本人删除的原件不从旧索引复活。",
};
...
const personalMediaModules = [
  commonModule({
    slug: "search-browse",
    usageEntry: "用地点、日期、画面或一句录音原话描述想找的内容。",
    usageInputs: ["地点、日期、画面、类型或原话线索", "录音内定位时选定的原音"],
    productFlow: [{"title": "系统核对并处理", "detail": "区分现场地点与画面文字，只查已有目录；确认候选原件仍在，录音片段只复用同原音已有时间段。"}, {"title": "交付与接续", "detail": "交回少量原件、匹配理由和必要的起止时间；证据或原件不足时说明缺口，临时浏览目录用完精确清理。"}],
    readerStatus: "当前目录有4,358项媒体，能按线索找现存原件；录音内定位依赖已有时间信息，目录记录不等于本轮逐件重新验真。",
    shortTitle: "查找与临时浏览",
    ...
    result: "拿到少量原件及其类型、已知日期、地点和匹配理由；需要一起看时，可得到不重复复制原件的临时浏览文件夹，用完清理不影响原件。查录音里的话时，还会给出从录音开头算起的时间段、有关文字和检查范围；文字可能识别有误，说话人的分组也不等于知道他的真实身份。",
    readerStates: {
  ...
  commonModule({
    slug: "classification",
    usageEntry: "把一小批已取得的照片或截图交给 AI，问哪些要留、分类或待复核。",
    usageInputs: ["本批可打开原件", "本人已有的保留或精选选择（如有）"],
    productFlow: [{"title": "系统核对并处理", "detail": "排开缓存和完全重复，再比较画面意义、质量与更完整版本；逐件给出保留、退出或待复核理由。"}, {"title": "交付与接续", "detail": "完整决定应用后更新目录与本地计划；跨批近重复和看不清的对象保留，备份、手机及云各自验收。"}],
    readerStatus: "照片六类目录与普通视频归位已有来源确认，照片精选910项；实际备份、云端播放和手机回写仍分别验收。",
    shortTitle: "分类、质量与去重",
    ...
    result: "每张图片或每段视频都有明确的保留或移出决定、分类、时间、说明和重复依据。照片精选没有数量配额，普通视频不另设精选目录。整理后核对原件位置、查找目录和后续恢复计划是否一致；实际备份、写回手机和上传云端各自另报结果。",
    readerStates: {
      pass: "本批每份不同内容都已看过并作出完整决定；保存分类后，留下的原件能找到，目录与手机、云端的后续计划也对应正确。计划准备好不等于已经传到手机或云端。",
      problem: "画面看不清、近重复关系不确定、唯一性或恢复责任未证明时保留原件/候选并只打开少量原图复核。",
      unavailable: "打不开文件、缺少看图依据或本批没有审完时，不应用整理决定。分类还没保存就失败时，撤回本批未完成的记录和新建链接；分类已保存、但后续清单更新失败时，保留原件和已保存分类，说明哪些清单还要补齐，不能说整批已经全部撤回或全部完成。"
    },
  ...
  commonModule({
    slug: "local-ingest",
    usageEntry: "点名一个已人工复核的本地照片、视频或录音，请 AI 接入媒体中心。",
    usageInputs: ["明确源文件与预期内容", "类别和说明", "视频容器变体才需指明既有主版本"],
    productFlow: [{"title": "系统核对并处理", "detail": "核对类型和字节；新原件写入正式目录与异卷恢复副本，容器变体先证明内容等价才记录关系。"}, {"title": "交付与接续", "detail": "交回目录、来源退休、手机与云候选的结果；哈希、卷或主版本不符时保留源文件。"}],
    readerStatus: "已有把一个已复核文件精确入库或登记现有原件的入口；本轮只读代码，没有接入真实新文件。",
    shortTitle: "独立本地文件接入",
    ...
    statusTone: "mixed",
    value: "把已经核对并决定保留的一份本地图片、视频或录音，接入现有媒体库，同时保存恢复副本并更新查找记录。当前入口要求暂存文件与媒体原件目录位于同一磁盘，不需要把它混进一批手机文件。",
    why: "一份文件可能来自电脑，也可能是同一段画面和声音的另一种文件封装。全部当新作品会重复保留；还没核对就删除，又可能丢掉唯一的完整版本。",
    example: "我可以说：“这个本地 MP4 看起来只是现有视频的另一种封装，核对后再接入，别重复保存两份正式原件。”系统会比较实际视频内容；确认相同后只把变体留作恢复材料并记录关系，无法确认就不动来源文件。",
    result: "新的保留内容在媒体原件目录落位，并在 G 盘留下恢复副本，查找目录和后续手机、云端计划随之更新。确证重复的视频变体会保留恢复副本和与主版本的对应关系，再退出原暂存位置。失败时说明已保存了哪些文件、哪一步还没完成。",
    readerStates: {
      pass: "原文件仍是之前确认的那一份、目标也没有冲突；媒体原件与 G 盘副本检查一致，查找记录和后续恢复计划已更新，再说明原暂存文件的处理结果。",
      problem: "分类、时间、主版本或视频重复关系还不能确认时，先保留文件，指出需要补看的画面或信息，不猜一个归属后直接接入。",
      unavailable: "暂存文件与媒体目录不在同一磁盘，或视频检查工具、原件目录、G 盘、目标位置及计划更新不可用时，停止对应步骤并报告已有副本。目前不会临时改成跨盘复制、手机批次处理或自动上传。"
    },
    decisionImpact: [
  ...
  commonModule({
    ...
    usageEntry: "连接手机后，说明要保全新共享文件并核对已在手机删掉的旧照片。",
    usageInputs: ["这次要处理的手机和共享文件范围", "本人想同步退出的旧件或对不确定旧件的选择"],
    readerStatus: "已发布流程会区分本人在手机删除的旧照片与这次新文件。这里未连接手机；实际删除、两盘保全、清空、再次回写和后续备份各按真实结果验收。",
    shortTitle: "手机双盘保全",
    title: "手机删掉的旧照片退出电脑，新文件先存好再拔线",
    ...
    statusTone: "mixed",
    value: "下次连接手机时，先确认哪些旧照片或视频是我真正删掉的，让它们退出电脑原件和本地手机恢复包；再把新共享文件存稳。这样不会把我删掉的东西又送回来，也不会因要整理新照片而长时间占着手机。",
    why: "手机上看不见一份旧文件，可能是本人删除，也可能只是改名、移到另一个目录，或上次由AI清空。如果不先分清，再做本次清理，就可能误删电脑原件，或者把本人已经删除的照片反复恢复回来。新增文件又必须先有两盘可靠副本，才能精确清理手机。",
    example: "“我在手机删了几张旧照片，也拍了新照片。下次接上时把删掉的旧件同步退出电脑，新文件存好后尽快告诉我能不能拔线。”AI会先对照上次真正完成的手机回写，核对删留，再给新增文件补齐两盘副本。拿不准的旧件先保留；它会分别说明删除了什么、新存了什么、手机是否已清空，以及哪些还没回写。",
    result: "拿到两组结果：旧受管图片/视频的同步删除、移动保留与未决项；新增共享文件的两盘保全、精确清空和可拔状态。电脑再离线整理并展示本批保留结果，准备好后第二次连接回写。电脑原件和本地手机包退出，不等于G/H镜像或云端已经删除。",
    readerStates: {
      "pass": "旧文件删留依据清楚，确认本人删除的受管图片/视频退出电脑原件和本地手机包；新文件两盘核对与手机精确清空都完成后告知可拔。后续整理、回写和备份另报结果。",
      "problem": "改名、移动、AI上次清空、未完成回写或前态不明时，不按缺失直接删电脑原件。独立的新文件保全可以继续；尚未核清移动去向时，先保住判断依据，不继续AI清空制造假删除。",
      "unavailable": "手机或来源目录不可读、设备身份不符、缺上次完整回写或任一副本不能核对时，说明受影响分支并保留原件和成功副本；整根离线不是本人删掉整库。"
    },
    ...
    implementation: [
      ...
      "capture对纳入分母的regular files最多取得3代稳定远端事实，先按SHA-256合并出现位置并查询媒体/材料库已核验原件；已有内容复用并补E/G缺口，每个真正新增哈希只pull一次。每个来源仍保留自己的路径、时间和精确清空责任，manifest/delete plan继续绑定本次run。",
      "protect-to-g 写 G 异卷；verify-backup 把 manifest、delete plan、设备身份、E/G bytes/SHA 全部绑定到 receipt。",
      "delete 要求同一当前设备、有效 backup receipt、精确 run-id 与 --execute，再核对路径/大小/哈希后逐文件删除；不删除目录。",
      "全局 lock、防覆盖 write_json_once 与 fresh run root 共同避免并发和旧 artifact 被静默复用。",
      "capture在本次AI清空前，以同一设备最后完整回写记录为前态核对受管图片/视频；按内容SHA-256、大小和现行locator确认本人删除，更新E原件、索引/种子、phone-recovery选择及G实际手机包。",
    ...
    flow: [
      ...
      "绑定本次run-id、manifest、delete plan及两盘bytes/SHA-256回执。",
    ...
    failures: [
      {
        "condition": "缺上次完整回写或无法证明旧件对应关系",
        "response": "不依据手机缺失删除电脑原件，记录未决范围；独立的新文件保全继续。"
      },
      {
        "condition": "旧文件只是移动、改名或由AI清空",
        "response": "按已核实来源保留或记录移动，不能冒充本人删除；移动观察未完成时先补齐，避免后续清空制造假象。"
      },
      {
        "condition": "E 或 G 任一回读失败",
        "response": "不宣布可以拔线；保留成功副本并只重试失败对象。"
      },
      {
        "condition": "删除前远端文件变化",
        "response": "停止该对象删除，保留本地副本和新远端事实。"
      },
      {
        "condition": "删除在隔离后中断",
        "response": "重跑同一 run：隔离字节与 plan hash 匹配时完成删除并记 RECOVERED_QUARANTINE_DELETED；隔离不匹配且源缺失时先尽力移回源再失败。最终扫描仍有任何 quarantine 就不能 PASS。"
      },
      {
        "condition": "用户拔线前未开始删除",
        "response": "正常结束保全，明确手机清空待下次连接。"
      }
    ],
    sources: [
      {
        "path": "phone_file_preserve_clear.py",
        "role": "手机捕获、双盘回读和精确清理"
      },
      {
        "path": "test_phone_file_preserve_clear.py",
        "role": "来源边界、批量快照、回读与删除保护回归"
      },
      {
        "path": "AGENTS.md",
        "role": "可以拔线节点与手机占用边界"
      ...
      {
        "path": "README.md（已发布22a6109，第144行）",
        "role": "手机删除同步电脑及已有命令范围"
      },
      {
        "path": "USER_REQUIREMENTS.md §3.6（已发布22a6109）",
        "role": "上次完整回写、移动/AI清空区分、未知不删、电脑原件与各层副本结果"
      }
    ],
    verification: ["2026-09-05旧回执有55项总测试、2项真机跳过；不是本轮测试或新手机流程的完整验收。", "回归覆盖恢复包根、Android/系统边界和 .nomedia 排除。", "真实设备墙钟仍需下一次连接复验。"],
    relation: "本模块先接住手机对旧受管图片/视频的删留，再把新共享文件安全带到电脑；分类和恢复差异由后续离线模块完成。G/H镜像与真实云删除分别交给原有入口，不从本次手机结果推定全部副本已消失。",
    readerStatus: "已发布流程同时处理旧照片的删留与新文件保全。本页没有连接手机；本次真实删除、清空、回写及备份同步仍要各自拿到结果。",
    productFlow: [
      {
        "title": "先看上次究竟写回了什么",
        "detail": "连接准确的手机，在本次AI清空之前核对上次完整且真实验过的回写记录；只有能对应电脑原件的受管图片/视频才进入旧文件删留判断。"
      },
      {
        "title": "分清本人删除和文件换了位置",
        "detail": "原位置没有文件时继续核对同内容是否移名、移动或在另一共享目录；回收站内容按本人已删处理。AI清空、访问失败和未完成回写不算本人删除，未知先保留。"
      },
      {
        "title": "让确认删掉的旧件退出电脑",
        "detail": "核对内容、大小和当前定位后，退出对应电脑原件、索引和本地手机恢复包；不动同名但内容已变化的文件，也不从旧备份补回来。G/H镜像待原任务同步，真正云端删除单独处理。"
      },
      {
        "title": "新增文件先有两盘可靠字节",
        "detail": "复用媒体库或材料库已经核对的相同内容，只补缺少的副本；新照片、视频、文档、压缩包和范围内其他共享文件都先保全，再分别交相应项目。"
      },
      {
        "title": "清空已保全的精确文件，再告知可拔",
        "detail": "两盘逐项核对通过后，只清这次已确认的手机文件，不递归删目录。隔离与删除收稳后及时告知可拔；提前断线就保留清空待办，不把备份成功说成清空完成。"
      },
      {
        "title": "电脑整理完，再连接回写",
        "detail": "离线完成分类、保留结果和恢复差异，主动报告未决项；准备好后再次连接，按手机当时真实差异回写。三阶段与各层副本各自验收。"
      }
    ]
  }),
  commonModule({
    slug: "phone-recovery",
    usageEntry: "说要准备手机照片视频恢复包；真正回写时再连接手机。",
    usageInputs: ["希望手机恢复的照片、视频或相册", "随身携带的优先级与容量选择（需要时）"],
    productFlow: [{"title": "系统核对并处理", "detail": "从当前保留集选出手机确实该有的照片视频，对照固定电脑包补齐或移除包内过时派生文件。"}, {"title": "交付与接续", "detail": "交回电脑包实际状态；第二次连接后才按手机真实差异回写并复核，未连接时明确停在准备完成。"}],
    readerStatus: "9月13日电脑端手机包已核对2,245项、约43GB；包准备好不代表手机已经写回，下一次连接仍需实际核对。",
    shortTitle: "手机恢复包",
    ...
    result: "先知道选中了多少照片和视频、共占多少空间、是否适合当前恢复包；再核对 G 盘里实际已有多少、还缺多少，并按选定范围补齐。预览只报缺项数量，出现同名内容冲突时才指出具体文件。电脑上有完整包，不等于手机已经写回成功。",
    readerStates: {
      pass: "所选内容与媒体目录一致，总量低于当前 60 GB 上限；G 盘预览检查没有缺项，大小都匹配。真正写入时还会核对文件内容，成功后才报告电脑恢复包完整，手机回写另验。",
      problem: "缺文件就报告待补数量；目标有同名但不同内容的文件时停止并指明冲突。原件或选择发生变化时重新核对计划。本人删除原件后，只移出能准确对应的恢复副本，不确定属于同一文件的内容先保留。",
  ...
  commonModule({
    ...
    usageEntry: "说明要预览或同步哪类媒体到既有 Google Photos 或 Drive。",
    usageInputs: ["要同步到 Photos、Drive 或两者的选择", "需要的相册关系和超出现有授权的范围（如有）"],
    productFlow: [{"title": "系统核对并处理", "detail": "先形成本地期望；预览只计算差异，独立执行入口才逐项处理云对象、相册关系和退出。"}, {"title": "交付与接续", "detail": "按真实远端回读说明对象、关系和播放状态；本地 synced 只代表本地记录，失败先核对已有对象再续作。"}],
    readerStatus: "当前4,358项云映射来自本地已保存状态；本轮没有重新访问云端、验证播放或完成手机回写。",
    shortTitle: "云端候选与同步",
    ...
    status: "当前4358项云端映射来自本地已提交状态；本轮未重做远端回读、播放或手机验收",
    statusTone: "mixed",
    ...
    implementation: [
      ...
      "具名照片相册参与期望集合和membership，不改变原件分类。重复增量沿已有内容哈希与远端ID处理，更新本地相册名不等于外部相册已更新；来源映射不足或矛盾时保留Unknown，不丢映射后重新全量上传。",
    ],
